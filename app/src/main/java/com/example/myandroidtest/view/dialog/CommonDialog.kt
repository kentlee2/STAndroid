package com.example.myandroidtest.view.dialog
...
class CommonDialog {
    ...
    open class Builder<B : Builder<B>>(context: Context) : BaseDialog.Builder<B>(context),
        ...
        fun setCustomView(@LayoutRes id: Int): B {
            return setCustomView(LayoutInflater.from(context).inflate(id, containerLayout, false))
        }
        ...
        fun setConfirm(@StringRes id: Int): B {
            return setConfirm(context.getString(id))
        }
