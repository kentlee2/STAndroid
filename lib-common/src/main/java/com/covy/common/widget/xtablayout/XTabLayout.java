...
public class XTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabContainer.setTabWidth(itemWidth);
    ...
    public void setTabScrollAnim(boolean tabScrollAnim) {
        this.mTabScrollAnim = tabScrollAnim;
    }
    ...
    public void setTabWidth(int itemWidth) {
        mTabContainer.setTabWidth(dip2px(itemWidth));
    }
