...
class XTabContainer extends FrameLayout {
    ...
    private FrameLayout mLineViewContainer;
    // 记录每个条目的宽度
    ...
    public XTabContainer(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mLineViewContainer = new FrameLayout(context);
        addView(mLineViewContainer, new LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    public void removeAllItemViews() {
        ...
        if (mLineView != null) {
            mLineViewContainer.removeView(mLineView);
            mLineView = null;
        }
    }
    ...
    public void setTabWidth(int itemWidth) {
    ...
    public void addLineView(View lineView) {
        ...
        mLineView = lineView;
        // 添加线
        mLineViewContainer.addView(lineView, getLineLayoutParams());
    }
